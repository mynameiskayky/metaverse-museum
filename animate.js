...
VanillaTilt.init(document.querySelector('.presetation-nft'), {
  max: 5,
  speed: 100
})
...
ScrollReveal().reveal('.presetation-nft', {
  delay: 200,
  distance: '100px',
  easing: 'ease-in-out',
  duration: 1500
...
ScrollReveal().reveal('.present-ticket', {
  delay: 200,
  distance: '100px',
  easing: 'ease-in-out',
  duration: 1500,
...
ScrollReveal().reveal('.footer-data', {
  delay: 200,
  distance: '100px',
  easing: 'ease-in-out',
  duration: 1500,
